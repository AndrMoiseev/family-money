...
@Component
class SpaRootHttpHandlerConfigurer(private val resources: SpaResources) : HttpHandlerConfigurer {
    override fun configure(next: HttpHandler): HttpHandler = HttpHandler { exchange ->
